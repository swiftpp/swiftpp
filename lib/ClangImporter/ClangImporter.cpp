...
getGlibcModuleMapPath(StringRef resourceDir, llvm::Triple triple,
  ...
  // `swiftppc -target x86_64-unknown-linux-gnu -emit-ir` is invoked using
...
getNormalInvocationArguments(std::vector<std::string> &invocationArgStrs,
  ...
  invocationArgStrs.insert(invocationArgStrs.end(), {
      ...
      languageVersion.preprocessorDefinition("__swiftpp__", {10000, 100, 1}),
  ...
  invocationArgStrs.insert(invocationArgStrs.end(), {
      "-fmodules",
      "-Xclang", "-fmodule-feature", "-Xclang", "swiftpp"
  });
