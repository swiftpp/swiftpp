...
// RUN: not %target-swiftppc_driver -continue-building-after-errors -D BROKEN -j 2 -typecheck -stats-output-dir %t %s %t/other.swift
...
// RUN: %target-swiftppc_driver -j 2 -typecheck -stats-output-dir %t %s %t/other.swift
// RUN: %{python} %utils/process-stats-dir.py --set-csv-baseline %t/stats.csv %t
